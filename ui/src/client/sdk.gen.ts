...
/**
 * Export Day Data
 * Export all assignments for a day as TSV (admin only)
 */
export const exportDayDataApiV1AdminUserDayDayDayIdExportGet = <ThrowOnError extends boolean = false>(options: Options<ExportDayDataApiV1AdminUserDayDayDayIdExportGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ExportDayDataApiV1AdminUserDayDayDayIdExportGetResponse, ExportDayDataApiV1AdminUserDayDayDayIdExportGetError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
